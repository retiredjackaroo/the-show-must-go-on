...
### Saving Throws, Senses and Defenses

- **Saving throw proficiencies:** Wisdom +6 and Charisma +2
- **Other saving throws:** Strength +2, Dexterity +1, Constitution +1 and Intelligence +0
- **Passive Perception:** 16
- **Passive Investigation:** 10
- **Passive Insight:** 16
- **Darkvision:** 120 feet
- **Poison:** Resistance to poison damage and advantage on saves to avoid or end the Poisoned condition
...
Other skill bonuses: Acrobatics +1, Animal Handling +4, Arcana +0, Athletics +2, Deception +0, History +0, Intimidation +0, Investigation +0, Nature +0, Performance +0, Persuasion +0, Religion +0, Sleight of Hand +1 and Stealth +1.

### Proficiencies and Languages

- **Armor:** Heavy armor, light armor, medium armor and shields
- **Weapons:** Martial weapons and simple weapons
- **Tools:** Brewer's supplies and smith's tools
- **Languages:** Common, Common Sign Language and Dwarvish

### Attacks and Divine Features

| Attack         |   Range | To Hit / Save |        Damage |
| -------------- | ------: | ------------: | ------------: |
| Guiding Bolt   | 120 ft. |            +6 |   4d6 radiant |
| Unarmed Strike |   5 ft. |            +4 | 3 bludgeoning |
